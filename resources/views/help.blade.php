...
<div class="out-body">
    ...
    <div id="content">
        <p></p><div><div id="content"><h3><b>关于我们</b></h3><p>为了减轻易班助理的工作负担，简化工作流程，同时为校级组织及各学院易班提供更加方便快捷的服务，特开发此网上操作系统。</p><p>此系统主要包括奖品申请、易班物资借用申请、校易班干事请假、库存管理四大功能，开设系统管理员、组织单位官方帐号等五大角色，并针对不同角色开放不同功能。</p><p>以下是关于此系统操作的帮助文档，请仔细阅读，如有任何疑问，欢迎留下反馈意见。</p><p style="text-align: right;"><b>西华师范大学易班学生工作站</b></p></div></div>
    </div>
</div>
